...
- [HTTP server](./network/http-server/README.md) - a document describing how to run a
...
- [HTTPS server](./network/https-server/) - scripts for creating a self-signed
  ...
  certificate
- [HTTP proxy](./network/proxy/README.md) - document describing how to setup an HTTP
  proxy (both plain HTTP proxy and authenticated HTTP proxy)
